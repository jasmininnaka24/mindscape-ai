...
router.get(
  "/get-category-value-group/:StudyGroupId/:category",
  async (req, res) => {
    try {
...
router.get(
  "/personal-study-material/:categoryFor/:UserId",
  async (req, res) => {
...
router.get(
  "/shared-material-category/:id/:categoryFor/:UserId",
  async (req, res) => {
    const { id } = req.params;
    const extractedCategory = await StudyMaterialsCategories.findOne({
      where: {
...
router.get(
  "/get-lastmaterial/:id/:StudyGroupId/:categoryFor/:UserId",
  async (req, res) => {
...
router.put("/update-study-performance/:id", async (req, res) => {
  ...
  try {
    const StudyMaterialsCategoriesData =
      await StudyMaterialsCategories.findByPk(categoryID);
...
router.put("/update-shared/:id", async (req, res) => {
  ...
  try {
    const StudyMaterialsCategoriesData =
      await StudyMaterialsCategories.findByPk(id);
