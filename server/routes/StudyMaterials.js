...
router.get(
  "/study-material/:materialFor/:StudyGroupId/:UserId/:id",
  async (req, res) => {
...
router.get(
  "/study-material-personal/:materialFor/:UserId/:id",
  async (req, res) => {
...
router.get(
  "/get-material-from-categoryId/:StudyMaterialsCategoryId",
  async (req, res) => {
...
router.get(
  "/get-material-from-categoryName/:StudyMaterialsCategoryId",
  async (req, res) => {
    const { StudyMaterialsCategoryId } = req.params;
    const materialResponse = await StudyMaterials.findAll({
      where: {
...
router.get(
  "/study-material-group-category/:materialFor/:StudyGroupId",
  async (req, res) => {
...
router.get(
  "/study-material-category/:materialFor/:UserId",
  async (req, res) => {
...
router.get(
  "/all-study-material-personal/:UserId/:StudyMaterialsCategoryId",
  async (req, res) => {
...
router.get(
  "/all-study-material-group/:StudyGroupId/:StudyMaterialsCategoryId",
  async (req, res) => {
