...
router.post("/", async (req, res) => {
  ...
  const SavedAssessmentData = await DashForPersonalAndGroup.create(
    assessmentData
  );
...
router.get(
  "/get-latest-assessment-group/:StudyMaterialId/:groupId",
  async (req, res) => {
...
router.get(
  "/get-latest-assessment-personal/:StudyMaterialId/:userId",
  async (req, res) => {
