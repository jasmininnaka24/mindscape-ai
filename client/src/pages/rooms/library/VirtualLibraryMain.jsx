...
export const VirtualLibraryMain = () => {
  ...
  const {
    ...
    groupStudyMaterials, groupStudyMaterialsCategory, sharedMaterials, sharedMaterialsCategory, sharedMaterialsCategoryUsers, sharedMaterialsCategoryBookmarks, currentMaterialTitle, currentMaterialCategory, setCurrentMaterialCategory, materialMCQ, materialMCQChoices, materialNotes, currentSharedMaterialIndex, setCurrentSharedMaterialIndex, filteredSharedCategories, filteredStudyMaterialsByCategory, setFilteredStudyMaterialsByCategory,
    currentFilteredCategory, currentFilteredCategoryUsers, currentFilteredCategoryBookmarks, groupNameValue, setGroupNameValue,
    searchValue, setSearchValue, searchCategoryValue, setSearchCategoryValue,
    searchedMaterials, searchCategory, searchCategoryUsers, searchCategoryBookmarks,
    searchedCategories, showModal, setShowModal, showPresentStudyMaterials, setShowPresentStudyMaterials, showMaterialDetails, setShowMaterialDetails,    enableBackButton, showBookmarkModal, setShowBookmarkModal, chooseRoom, setChooseRoom,
    chooseGroupRoom, setChooseGroupRoom, showCreateGroupInput, setShowCreateGroupInput,
    showContext, setShowContext, context, showNotes, setShowNotes, showQuiz, setShowQuiz,
    isDone, setIsDone, deleteModal, setDeleteModal, setMaterialIdToRemove, setMaterialIdToRemoveBookmarkCounts, buttonLoading, buttonLoader, buttonLoaderIndex, 
    currentMaterial,buttonClickedNumber, btnClicked, toggledCategory, setToggledCategory, UserId, userData, fetchData, getUserData, toggleCategory, viewStudyMaterialDetails, shareMaterial, bookmarkMaterial, filterMaterial, handleSearchChange, handleCategorySearch, createGroupBtn, removeFromLibraryOnly, deleteInAllRecords, loading
  } = LibraryComponent();
