    ...
    <div class="">
      ...
      <div className='about-page' data-aos='fade-up'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <h2 className="text-4xl font-medium text-center py-10 lora">What is MindScape about?</h2>
          <div className="line"></div>
        </div>
