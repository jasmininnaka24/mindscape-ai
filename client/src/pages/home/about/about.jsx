  ...
  return (
    <div className="">
      ...
      <div className='about-page' data-aos='fade-up'>
        ...
        {/* 2 boxes container */}
        <div className={`flex ${(!largeDevices && !extraLargeDevices) ? 'flex-col text-justify' : 'flex-row text-justify'} justify-between items-center`}>

          {/* image */}
          <div className={`box-border-left flex items-center justify-center ${(!largeDevices && !extraLargeDevices) ? 'w-full' : 'w-1/3'}`}>
            <img className={(!largeDevices && !extraLargeDevices) ? 'w-1/2' : 'w-[80%]'} src={studyPic} alt="" />
          </div>
