    ...
    try {
      ...
      try {
        if (groupId === undefined) {
          ...
          console.log(studyMaterialResponse.data);
          ...
          studyProf = fetchedPreferredStudyProf.data;
        }

        setPreferredtudyProf(studyProf);

        console.log(studyProf);
    ...
    <div className="poppins mcolor-900 mbg-200 relative flex">
      ...
      >
        <div className={`flex items-center mt-6`}>
          ...
          <Navbar
            linkBack={`/main/${
              categoryFor === "Personal" ? "personal" : "group"
            }/dashboard/${categoryFor === "Personal" ? "" : groupId}`}
            linkBackName={`Dashboard`}
        ...
        <div className="mbg-input border-medium-800 min-h-[80vh] rounded-[5px] mt-7 overflow-x-auto">
          ...
          >
            <thead className="mbg-800 mcolor-100">
              <tr>
                <th className="text-center py-3 px-10 font-medium">
                  Categories
                </th>
                <th className="text-center py-3 px-10 font-medium">
                ...
                .map((item, index) => {
                  return (
                    ...
                    >
                      ...
                      <td className="text-center py-3 mcolor-800 w-1/4">
                        {performanceStatusArr[index]}%
                      </td>
                      <td className="text-center py-3 mcolor-800">
                        {performanceStatusArr[index] >= preferredStudyProf
                          ? "Passing"
                      ...
                      <td className="text-center py-3 mcolor-800">
                        {tag === "Own Record" || tag === "Shared"
                          ? (() => {
                              const filteredOwnRecord =
                                ownRecordStudyMaterials.filter(
                          ...
                          : (() => {
                              const filteredBookmarks =
                                bookmarkedStudyMaterials.filter(
                                  (material) =>
