        ...
        {sidebarOpen && (
          <motion.div
            ...
            className={`fixed h-[100vh] flex flex-col items-center justify-between py-2 ${
              extraLargeDevices
                ? "w-1/6"
                : sidebarOpen && largeDevices
                ? "w-1/4"
                : sidebarOpen && (smallDevice || mediumDevices)
                ? "w-1/2"
                : "w-full"
            } mbg-800`}
          ...
          >
            ...
            <div className="text-center my-8">
              <Link>
                <h3 className="mcolor-300 text-2xl my-1">
                  <SpaIcon className="mb-2" /> MindScape
                </h3>
              </Link>
              <div className="flex items-center relative mx-5 mt-3 mb-7">
                <div className="w-full">
                  <input
                    ...
                    className={`border-thin-800 mbg-input rounded py-2 px-5 ${
                ...
                {searchTerm && (
                  <div
                    ...
                    } absolute mbg-input top-12 p-3 border-thin-800 w-full rounded max-h-[50vh] ${
                      extraLargeDevices || largeDevices
                        ? "text-md"
                        : extraSmallDevice
                        ? "text-xs"
                  ...
                  >
                    ...
                    {searchResults.map((user) => (
                      <div
                        ...
                        style={{ borderBottom: "1px #999 solid" }}
                      >
                        <p>
                          <PersonOutlineIcon className="mr-1" />
                          {user.username}
                        </p>
            ...
            >
              <li
                className={`my-1 py-4 pl-5 ml-2 text-md ${
                  currentPage === "profile"
                    ? "rounded-side mbg-200 mcolor-800"
                    : "rounded"
                }`}
              >
              ...
              <li
                className={`my-1 py-4 pl-5 ml-2 text-md ${
                  currentPage === "personal-study-area"
                    ? "rounded-side mbg-200 mcolor-800"
                    : "rounded"
                }`}
              >
            ...
            <div className="mcolor-100 py-3 w-full px-5">
              <button
                className="text-lg rounded py-1 mbg-700 w-full"
